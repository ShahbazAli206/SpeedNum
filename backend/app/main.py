...
for router in (
    ...
    platform_finance.router,
    platform_invoices.router,
    plan_requests.router,
    plan_requests.admin_router,
    plans_admin.router,
    support.router,
    support.admin_router,
    portal.router,
    public.router,
    firm_invoices.router,
    firm_bills.router,
    client_invoices.router,
    client_expenses.router,
    client_engagements.router,
    client_firm_invoices.router,
    client_messages.router,
